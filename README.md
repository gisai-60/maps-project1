...
## Key aspects of digital mapping
   ...
   - Data analysis: [Digital maps](https://library.princeton.edu/services/maps-geospatial-information-center) are powerful tools for analyzing data. For example, they can be used to visualize demographic changes, analyze environmental data, or identify patterns that aren't obvious in a spreadsheet. 
