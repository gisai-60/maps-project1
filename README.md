...
## Key aspects of digital mapping
   ...
   - Data analysis: [Digital maps][def] are powerful tools for analyzing data. For example, they can be used to visualize demographic changes, analyze environmental data, or identify patterns that aren't obvious in a spreadsheet. 


[def]: https://maptelligent.com/blog/what-is-digital-mapping/